...
public final class ActionContainer
{
	...
	public ActionContainer(List<Class<?>> actCls, List<Class<?>> paramCls, List<Class<?>> retParamCls, FrameworkSpi userInterface) throws Exception
	{
		// 日志
		...
		ActionParser actionParser = new ActionParser(userInterface);
		// 加入框架内置接口
