...
public class ActionParser
{
	...
	public ActionParser(FrameworkSpi userInterface)
	{
			...
			Map<String, Map<String, ReturnParameterEntity>> retparamMap) throws Exception
	{
		...
		// 开始创建工作流,完整流程为：crossdomain(must)->authenticate(optional)->checkparam(must)->permission(optional)->transaction(optional)->action(must)
