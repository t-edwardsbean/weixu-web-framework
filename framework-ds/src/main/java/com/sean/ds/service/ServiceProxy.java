	...
	public Object invoke(Object proxy, final Method method, final Object[] args) throws Throwable
	{
		...
		FutureTask<Object> task = new FutureTask<>(new Callable<Object>()
		{
			...
			public Object call() throws Exception
			{
					...
					try
					{
						while (true)
						{
							...
							catch (Exception e)
							{
								...
								{
									curr = System.currentTimeMillis() - curr;
									logger.debug("调用时间:" + curr + ", 业务异常: " + exception);
									break;
								}
								// 其他异常视为通信异常
								else
								{
									logger.error("ds服务通信异常", exception);
									...
									{
										logger.debug("尝试失败重试, 但是没有在线服务实例");
										break;
									}
								}
							}
				...
				{
					exception = new RuntimeException("服务" + serviceDefine.serviceName + "没有在线的服务实例存在");
				}
				return exception;
			}
		});
