...
public abstract class Entity
{
	...
	public void genCode()
	{
		...
		System.out.println("public Map<String, Object> getValues()");
		System.out.println("{");
		...
		System.out.println();
		System.out.println("@Override");
		System.out.println("public void setValues(EntityValue vals)");
		System.out.println("{");
		for (Field it : fields)
		{
			System.out.print("\t");
		...
		for (Field it : fields)
		{
			String field = it.getName().toUpperCase().charAt(0) + it.getName().substring(1);
			System.out.println("public static final String " + field + " = \"" + it.getName() + "\";");
		}
